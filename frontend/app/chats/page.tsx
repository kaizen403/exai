...
export default function ChatsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      {/* Outer container with margin on desktop */}
      <div className="w-full max-w-md mx-4 min-h-[600px] bg-gray-800 rounded-3xl shadow-lg border border-gray-700 overflow-hidden flex flex-col">
        {/* Top Bar */}
          ...
          {processing && (
            <div className="absolute inset-0 bg-gray-900 bg-opacity-80 z-10 flex items-center justify-center">
              <p className="text-md font-semibold">
                Indexing chat.. might take few mins for very long chats
              </p>
            </div>
          )}
